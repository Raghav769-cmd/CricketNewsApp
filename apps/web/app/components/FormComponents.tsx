...
export const FormError: React.FC<FormErrorProps> = ({ message, show = true }) => {
  if (!show || !message) return null;

  return (
    <div className="mt-2 p-3 bg-red-500/10 border border-red-500/30 rounded-lg flex items-start space-x-3 animate-in fade-in slide-in-from-top-1 duration-200">
...
export const FormField: React.FC<FormFieldProps> = ({
  ...
  return (
    <div>
      ...
      {error && <FormError message={error} show={!!error} />}
    </div>
  );
};
